...
class FirebaseNotificationManager {
  ...
  void init() async {
    ...
    // Skip FCM network setup in debug to reduce emulator noise
    if (kDebugMode) {
      Loggers.warning('FCM initialization skipped in debug mode');
      return;
    }

    // Permission + FCM subscriptions in release/staging only
